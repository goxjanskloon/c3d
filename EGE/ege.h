...
// 3d 计算辅助函数
void EGEAPI rotate_vector3d_x(VECTOR3D  * pt, float r); //弧度，右手定则
void EGEAPI rotate_vector3d_y(VECTOR3D  * pt, float r);
void EGEAPI rotate_vector3d_z(VECTOR3D  * pt, float r);
